...
const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "A vegan recipe application that helps users discover new vegan recipes every day. It also allows searching for specific vegan dishes.",
  ...
  },
  {
    ...
    image: project2,
    description:
      "A streamlined application designed to efficiently manage books, users, and borrowing records. It enables librarians to track book availability, issue and return books, and maintain user details.",
  ...
  },
  {
    ...
    image: project3,
    description:
      "A simple weather application with a clean UI that allows users to check the weather of any location.",
    technologies: ["XML", "Java", "Android Studio"],
  },
];
